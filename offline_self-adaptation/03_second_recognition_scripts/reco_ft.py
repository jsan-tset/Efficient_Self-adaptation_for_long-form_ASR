...
if len(sys.argv)!=5:
    sys.exit("%s <audio_path> <chkp_path:path/to/5epoch.pth> <output_dir> <model>")
...
create_lora_adapter(model.s2t_model, rank=16, alpha=32, dropout_rate=0.1, target_modules=LORA_TARGET)
